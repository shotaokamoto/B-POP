...
namespace Ctrl
{
    public class DrawManager : MonoBehaviour
    {
        ...
        {
            int LoopCount = 0;
            for(int i = 0; _DrawDataList[i][0] != (int)CardName.DrawObjEnd; i++)
            {
                LoopCount++;
            }
        ...
        {
            // カードを生成
            CardObj.Add(Instantiate(Card[data[0] - 1], View[SubScript[data[3] - pNum + 3]], transform.rotation, _AllFieldObj[data[1]][data[2]].transform));
        ...
        private void DrawRankUp()
        {
            ...
            for (int i = 0; _DrawDataList[i][0] != (int)CardName.DrawRankUpEnd; i++)
            {
                // ランクアップエフェクトの生成
        ...
        private void DrawClosed()
        {
            ...
            for (int i = 0; _DrawDataList[i][0] != (int)CardName.DrawClosedEnd; i++)
            {
                // 廃業エフェクトの生成
