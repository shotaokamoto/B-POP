...
public class GameManger : NetworkBehaviour
{
    ...
    public Player[] players;            //サーバ側で持っておくべき情報
    ...
    public override void OnStartServer()
    {
        if (size.Count != players.Length)
        {
            ...
            //players[size.Count].GetComponent<Ctrl.BldgData_Maneger>().myClientData.useCardData.PlayerNum = size;
            //Debug.Log(player.GetComponent<UIMgr>().useCardData.PlayerNum);
        }
    }
