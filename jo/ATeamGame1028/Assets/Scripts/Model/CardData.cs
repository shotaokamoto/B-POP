...
namespace Model
{
    public class CardData
    {
        ...
        private int _CardRarity;    //カードのレアリティ
        ...
        public int Rarity
        {
            ...
            set
            {
                ...
                if (eveCardData != null)
                {
                    KeyValueUpdate kv = new KeyValueUpdate("Rarity", Rarity);
                    eveCardData(kv);
                }
            }
        }
        ...
        //共有構造関数
        public CardData(int number, string name, string text, int cost,int score,int type,int rarity)
        {
