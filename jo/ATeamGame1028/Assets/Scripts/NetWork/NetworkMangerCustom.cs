...
public class NetworkMangerCustom : NetworkManager
{
    ...
    public override void OnServerAddPlayer(NetworkConnection conn, short playerControllerId)
    {
        ...
        Log.Write(player.gameObject.GetComponent<Ctrl.LocalPlayerManeger>().playerNum+1+"人いますよ");
        ...
        if (player.gameObject.GetComponent<Ctrl.LocalPlayerManeger>().playerNum == 3)
        {
            UIGameManger.Instance.RpcStarting();
        }
    }
