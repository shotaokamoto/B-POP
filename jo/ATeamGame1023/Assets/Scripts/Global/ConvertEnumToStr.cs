...
namespace Global
{
    public class ConvertEnumToStr
    {
        ...
        private ConvertEnumToStr()
        {
            ...
            _DicScenesEnumLib.Add(ScenesEnum.StartScenes, "StartScene");
            _DicScenesEnumLib.Add(ScenesEnum.LoadingScenes, "LoadingScenes");
            _DicScenesEnumLib.Add(ScenesEnum.LogonScenes, "LogonScenes");
            _DicScenesEnumLib.Add(ScenesEnum.GameScenes, "GameScene");
            _DicScenesEnumLib.Add(ScenesEnum.ResultScenes, "ResultScenes");
