...
namespace Model
{
    public class PlayerDataProxy : PlayerData
    {
        ...
        public PlayerDataProxy(int PlayerNumber,int TotalScore,int ScorePerTurn,int Ranking)
            :base(PlayerNumber,TotalScore,ScorePerTurn, Ranking)
        {
            if(_Instance == null)
            {
                _Instance = this;
