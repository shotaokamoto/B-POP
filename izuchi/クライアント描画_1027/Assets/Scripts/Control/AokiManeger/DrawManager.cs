    ...
    public class DrawManager : MonoBehaviour
    {
        ...
        private void DrawMain()
        {
            if (AllSetTime + WaitTime < Time.time)
            {
                ...
                switch (_NowDrowFaze)
                {
                    case (int)DrawFaze.DrawAct:     // アクション描画
                        DrawAction();
                        break;
        ...
        private void DrawAction()
        {
            for (int i = 0; i < _DrawDataList.Count; i++)
            {
                ...
                {
                    switch (NowActionFase[i])
                    {
                        case (int)ActionFaze.Mine:
                            //ここに地雷描画処理
                    ...
                    if (NowActionFase[i] == (int)ActionFaze.ActionEnd)
                    {
