    ...
    public class PlayerData
    {
        ...
        public int Ranking
        {
            ...
            set
            {
                ...
                if (eveCardData != null)
                {
                    KeyValueUpdate kv = new KeyValueUpdate("Ranking", Ranking);
                    eveCardData(kv);
                }
            }
        }
        ...
        //共有構造関数
        public PlayerData(int playernumber, int totalscore, int scoreperturn, int ranking)
        {
