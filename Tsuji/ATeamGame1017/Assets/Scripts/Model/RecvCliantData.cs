...
namespace Model
{
    public class RecvCliantData
    {
        ...
        private FieldDataProxy[][] _AllFeildData;   //全フィールドデータ
        private PlayerDataProxy[] _AllPlayerData;   //全プレイヤーデータ
        private int _NowTurn;                       //現在のターン
        private List<List<int>> _DrawDataList;      //描画メソッドに必要なデータ
        private List<CardDataProxy> _DrawCardList;  //引くカードのデータ
