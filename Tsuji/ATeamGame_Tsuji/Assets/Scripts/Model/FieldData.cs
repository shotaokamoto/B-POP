...
namespace Model
{
    public class FieldData
    {
        ...
        private int _PossessionPlayer;
        private int _MaptipNumber;
        ...
        //共有構造関数
        public FieldData(CardData cardData,int possessionPlayer,int maptipNumber,bool isRankUp,int rankID)
        {
