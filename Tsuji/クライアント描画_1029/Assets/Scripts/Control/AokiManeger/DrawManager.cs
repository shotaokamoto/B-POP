...
namespace Ctrl
{
    public class DrawManager : MonoBehaviour
    {
        ...
        public List<GameObject> CardObj;    //カードオブジェクトのプレハブリスト
        ...
        public Shader[] PlayerSharder = new Shader[4]; 
        ...
        void Start()
        {
            ...
            //playerの色を指定
            playerColor[0] = new Color32(255, 0, 0, 255); //赤
            playerColor[1] = new Color32(0, 0, 255, 255);  //青
            playerColor[2] = new Color32(255, 255, 0, 255); //黄
            playerColor[3] = new Color32(0, 255, 0, 255); //緑
        ...
        private void CreateRestaurants(List<int> data)
        {
            ...
            //オブジェクトを生成
            obj = Instantiate(MiniObject[data[0]], pos, transform.rotation, _AllFieldObj[data[1]][data[2]].transform) as GameObject;
            //マテリアル取得
            //カラーはdata[3]
            obj.transform.GetChild(0).GetChild(0).GetComponent<Renderer>().material.SetColor("_OutlineColor", playerColor[data[3] - 1]);
            obj.transform.GetChild(0).GetChild(1).GetComponent<Renderer>().material.SetColor("_OutlineColor", playerColor[data[3] - 1]);
            obj.transform.GetChild(0).GetChild(2).GetComponent<Renderer>().material.SetColor("_OutlineColor", playerColor[data[3] - 1]);
        ...
        private void CreateTapiocaShop(List<int> data)
        {
            ...
            obj.transform.GetChild(0).GetChild(1).GetComponent<Renderer>().material.SetColor("_OutlineColor", playerColor[data[3] - 1]);
            obj.transform.GetChild(0).GetChild(2).GetComponent<Renderer>().material.SetColor("_OutlineColor", playerColor[data[3] - 1]);
            obj.transform.GetChild(0).GetChild(3).GetComponent<Renderer>().material.SetColor("_OutlineColor", playerColor[data[3] - 1]);
        ...
        private void CreateSupermarket(List<int> data)
        {
            ...
            //オブジェクトを生成
            obj = Instantiate(MiniObject[data[0]], pos, transform.rotation, _AllFieldObj[data[1]][data[2]].transform);
            //マテリアル取得
            //カラーはdata[3]
            obj.transform.GetChild(0).GetChild(0).GetComponent<Renderer>().material.SetColor("_OutlineColor", playerColor[data[3] - 1]);
        }
        ...
        private void CreateBuildingEffect(List<int> data)
        {
            ...
            //オブジェクトを生成
            obj = Instantiate(BuildingEffect, pos, transform.rotation, _AllFieldObj[data[1]][data[2]].transform);
